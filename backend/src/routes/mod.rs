...
use self::{auth::auth_routes, customer::customer_routes, employee::employee_routes, product::product_routes, raw_material::raw_matrial_routes, shop::shop_routes, transaction::transaction_routes};
